 ...
 */
 ...
 type PromiseWorker<T extends ExposedFunctions> = {
   ...
   [K in keyof T]: T[K] extends (...args: infer Args) => infer Result
     ...
     : never;
 } & { terminate: () => void } & { calculateArmStates: (motor_: MotorDict, ratio_: RatioDict, comLength_: MeasurementDict, armMass_: MeasurementDict, currentLimit_: MeasurementDict, startAngle_: MeasurementDict, endAngle_: MeasurementDict, efficiency: number, iterationLimit: number) => Promise<MomentaryArmState[]> };
